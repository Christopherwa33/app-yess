...
public class MagazzinoController extends HttpServlet {
	...
	private static final String TEMPLATE_FOLDER = 
			"C:\\Users\\lucaf\\Desktop\\Java Intermedio\\"
			+ "01.1 DummyGestionale\\src\\main\\webapp\\"
			+ "WEB-INF\\templates\\";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// faccio l'equals "invertito" perché risulta essere "null safety"
		// in quanto, a differenza della variabile "cmd"
		// la stringa "add" non sarà mai null
    	if ("add".equals(cmd)) {
    		// in realtà non siamo mai sicuri del fatto che arrivino tutti questi
    		// parametri
    		// però facciamo finta che arrivi sempre tutto, altrimenti
